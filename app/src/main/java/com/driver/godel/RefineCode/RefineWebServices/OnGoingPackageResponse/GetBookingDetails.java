...
public class GetBookingDetails implements Parcelable
{
    ...
    protected GetBookingDetails(Parcel in) {
        handle_by = in.readString();
        preferred_deliver_time = in.readString();
        delivery_type = in.readString();
        vehicle_type = in.readString();
        recurring_id = in.readString();
        id = in.readString();
        is_cancel = in.readString();
        updated_at = in.readString();
        delivery_session = in.readString();
        booking_delivery_datetime = in.readString();
        booking_type = in.readString();
        created_at = in.readString();
        is_recurring_parent = in.readString();
        booking_note = in.readString();
        booking_code = in.readString();
        user_id = in.readString();
        booking_pickup_datetime = in.readString();
    }

    public static final Creator<GetBookingDetails> CREATOR = new Creator<GetBookingDetails>() {
        @Override
        public GetBookingDetails createFromParcel(Parcel in) {
            return new GetBookingDetails(in);
        }

        @Override
        public GetBookingDetails[] newArray(int size) {
            return new GetBookingDetails[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(preferred_deliver_time);
        dest.writeString(delivery_type);
        dest.writeString(vehicle_type);
        dest.writeString(recurring_id);
        dest.writeString(id);
        dest.writeString(is_cancel);
        dest.writeString(updated_at);
        dest.writeString(delivery_session);
        dest.writeString(booking_delivery_datetime);
        dest.writeString(booking_type);
        dest.writeString(created_at);
        dest.writeString(is_recurring_parent);
        dest.writeString(booking_note);
        dest.writeString(booking_code);
        dest.writeString(user_id);
        dest.writeString(booking_pickup_datetime);
    }
}
