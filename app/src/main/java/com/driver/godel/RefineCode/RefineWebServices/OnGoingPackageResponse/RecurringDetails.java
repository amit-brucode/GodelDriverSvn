...
public class RecurringDetails implements Parcelable
{
    private String id;
    ...
    protected RecurringDetails(Parcel in) {
        id = in.readString();
        is_deleted = in.readString();
        updated_at = in.readString();
        recurring_day_time = in.readString();
        recurring_week = in.readString();
        created_at = in.readString();
        recurring_status = in.readString();
        recurring_pickup_type = in.readString();
        recurring_day = in.readString();
    }

    public static final Creator<RecurringDetails> CREATOR = new Creator<RecurringDetails>() {
        @Override
        public RecurringDetails createFromParcel(Parcel in) {
            return new RecurringDetails(in);
        }

        @Override
        public RecurringDetails[] newArray(int size) {
            return new RecurringDetails[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(recurring_day_time);
        dest.writeString(recurring_week);
        dest.writeString(created_at);
        dest.writeString(recurring_status);
        dest.writeString(recurring_pickup_type);
        dest.writeString(recurring_day);
    }
}
