...
public class Data {
    ...
    public String toString() {
        return "ClassPojo [preferred_deliver_time = " + preferred_deliver_time + ", warehouse_pickup_address = " + warehouse_pickup_address + ", is_warehouse_dropoff = " + is_warehouse_dropoff + ", delivery_type = " + delivery_type + ", is_warehouse_pickup = " + is_warehouse_pickup + ", booking_id = " + booking_id + ", user_details = " + user_details + ", location_details = " + location_details + ", package_details = " + package_details + ", is_cancel = " + is_cancel + ", min_delivery_time = " + min_delivery_time + ", delivery_session = " + delivery_session + ", booking_delivery_datetime = " + booking_delivery_datetime + ", booking_type = " + booking_type + ", booking_note = " + booking_note + ", booking_code = " + booking_code + ", warehouse_details = " + warehouse_details + ", warehouse_drop_off_address = " + warehouse_drop_off_address + ", booking_pickup_datetime = " + booking_pickup_datetime + "]";
    }
}
