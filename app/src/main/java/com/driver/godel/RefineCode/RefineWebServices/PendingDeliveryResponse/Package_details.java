package com.driver.godel.RefineCode.RefineWebServices.PendingDeliveryResponse;

/**
 * Created by Ajay2.Sharma on 7/19/2018.
 */
...
public class Package_details {
    ...
    private String cash_accept_driver_id;
    ...
    private String is_valid_booking;
    ...
    public String getCash_accept_driver_id ()
    {
        return cash_accept_driver_id;
    }

    public void setCash_accept_driver_id (String cash_accept_driver_id)
    {
        this.cash_accept_driver_id = cash_accept_driver_id;
    }
    ...
    public String getIs_valid_booking ()
    {
        return is_valid_booking;
    }

    public void setIs_valid_booking (String is_valid_booking)
    {
        this.is_valid_booking = is_valid_booking;
    }
    ...
    {
        return "ClassPojo [handle_by = "+handle_by+", ucc_tax = "+ucc_tax+", final_price = "+final_price+", package_status = "+package_status+", cash_accept_driver_id = "+cash_accept_driver_id+", package_description = "+package_description+", pop_image = "+pop_image+", payment_details = "+payment_details+", payment_status = "+payment_status+", is_valid_booking = "+is_valid_booking+", feedback = "+feedback+", discount_type = "+discount_type+", package_type = "+package_type+", package_code = "+package_code+", driver_device_token = "+driver_device_token+", created_at = "+created_at+", driver_id = "+driver_id+", partner_user_id = "+partner_user_id+", tracking_id = "+tracking_id+", signature = "+signature+", package_height = "+package_height+", package_depth = "+package_depth+", fk_booking_id = "+fk_booking_id+",is_first_round_completed = " + is_first_round_completed + ", is_round_trip = " + is_round_trip + ",  package_quantity = "+package_quantity+", advance_payment = "+advance_payment+", warehouse_user_id = "+warehouse_user_id+", vat_tax = "+vat_tax+", discount = "+discount+", pod_image = "+pod_image+", sign_name = "+sign_name+", estimate_price = "+estimate_price+", updated_at = "+updated_at+", package_est_value = "+package_est_value+", package_width = "+package_width+", package_id = "+package_id+", send_selected_driver = "+send_selected_driver+", package_cancel = "+package_cancel+", rating = "+rating+", package_length = "+package_length+", package_weight = "+package_weight+", is_cash_on_pickup = "+is_cash_on_pickup+"]";
    }
}
