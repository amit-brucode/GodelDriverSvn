...
public class PackageStatusData {
    ...
    public String toString() {
        return "ClassPojo [package_height = " + package_height + ", dropoff_location_lat = " + dropoff_location_lat + ", pickup_street = " + pickup_street + ", fk_booking_id = " + fk_booking_id + ", package_status = " + package_status + ", package_quantity = " + package_quantity + ", pickup_location_lng = " + pickup_location_lng + ", dropoff_house_no = " + dropoff_house_no + ", pickup_house_no = " + pickup_house_no + ", dropoff_location = " + dropoff_location + ", pickup_landmark = " + pickup_landmark + ", user_email = " + user_email + ", id = " + id + ", updated_at = " + updated_at + ", dropoff_location_datetime = " + dropoff_location_datetime + ", user_phone = " + user_phone + ", name = " + name + ", pickup_location_lat = " + pickup_location_lat + ", dropoff_street = " + dropoff_street + ", created_at = " + created_at + ", package_width = " + package_width + ", pickup_datetime = " + pickup_datetime + ", dropoff_landmark = " + dropoff_landmark + ", dropoff_location_lng = " + dropoff_location_lng + ", pickup_location = " + pickup_location + ", package_weight = " + package_weight + "]";
    }
}
