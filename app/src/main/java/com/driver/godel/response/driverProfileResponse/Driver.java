...
public class Driver
{
    ...
    {
        return "ClassPojo [vechicle_name = "+vechicle_name+", driver_image = "+driver_image+", driver_phone = "+driver_phone+", driver_app_notification = "+driver_app_notification+", driver_name = "+driver_name+", vehicle = "+vehicle+", confirmation_code = "+confirmation_code+", driver_status_change_time = "+driver_status_change_time+", driver_lat = "+driver_lat+", password = "+password+", vechicle_type = "+vechicle_type+", driver_email = "+driver_email+", id = "+id+", updated_at = "+updated_at+", driver_lng = "+driver_lng+", driver_status = "+driver_status+", created_at = "+created_at+", vechicle_color = "+vechicle_color+"]";
    }
}
