package com.driver.godel.response.packageStatus;
...
public class UpdatePackageData
{
    ...
    {
        return "ClassPojo [delivery_type = "+delivery_type+", pickup_street = "+pickup_street+", package_status = "+package_status+", dropoff_location = "+dropoff_location+", pickup_landmark = "+pickup_landmark+", user_email = "+user_email+", id = "+id+", dropoff_location_datetime = "+dropoff_location_datetime+", delivery_session = "+delivery_session+", name = "+name+", pickup_location_lat = "+pickup_location_lat+", dropoff_street = "+dropoff_street+", created_at = "+created_at+", dropoff_location_lng = "+dropoff_location_lng+", booking_pickup_datetime = "+booking_pickup_datetime+", dropoff_location_lat = "+dropoff_location_lat+", package_height = "+package_height+", fk_booking_id = "+fk_booking_id+", dropoff_house_no = "+dropoff_house_no+", pickup_location_lng = "+pickup_location_lng+", package_quantity = "+package_quantity+", pickup_house_no = "+pickup_house_no+", fk_package_code = "+fk_package_code+", updated_at = "+updated_at+", user_phone = "+user_phone+", booking_delivery_datetime = "+booking_delivery_datetime+", booking_type = "+booking_type+", pickup_datetime = "+pickup_datetime+", dropoff_landmark = "+dropoff_landmark+", package_id = "+package_id+", package_width = "+package_width+", pickup_location = "+pickup_location+", package_weight = "+package_weight+"]";
    }
}
